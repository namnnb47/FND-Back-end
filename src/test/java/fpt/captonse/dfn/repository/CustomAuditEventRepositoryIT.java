...
import fpt.captonse.dfn.config.audit.AuditEventConverter;
import fpt.captonse.dfn.domain.PersistentAuditEvent;
...
import static fpt.captonse.dfn.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
